          ...
          <div className="group">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-emerald-500/20 border border-emerald-500/30 rounded-lg flex items-center justify-center hover:bg-emerald-500/30 hover:border-emerald-400 transition-all duration-300 cursor-pointer hover:scale-110"
              >
