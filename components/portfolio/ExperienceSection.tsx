          ...
          <div className="space-y-8 animate-fade-in-up">
            {experiences.map((exp, idx) => (
              ...
              >
                ...
                <div className="relative bg-gray-900/90 backdrop-blur-xl border border-emerald-500/20 rounded-2xl p-6 md:p-8 shadow-2xl hover:shadow-emerald-500/20 transition-all duration-300">
                  {/* Inner Glow */}
